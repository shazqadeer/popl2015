...
the precondition and the first component of the linear interface of $P$.
...
The linear permissions for the yields at call and return are the first and second components of the linear interface of $P$ respectively.
