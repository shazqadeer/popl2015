...
{
\lins,\lins';\RefinementAny;\ABlockInside \vdash \call{A} : \lins,\lins''
}
\;(\textsc{Atomic})
$
\medskip
...
{
\lins,\lins';\RefinementAny;\ABlockOutside \vdash \call{P} : \lins,\lins''
}
\;(\textsc{Proc})
$
\medskip
...
{
\lins,\lins';\RefinementAny;\ABlockOutside \vdash \async{P} : \lins
}
\;(\textsc{Async})
$
\medskip
