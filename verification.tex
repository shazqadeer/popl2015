...
{\FH{\phi_1 \wedge e}{\ablock{e,\lins}{s}}{\phi_2}}
\;(\textsc{Ablock})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\FH{\phi_1}{\StmtStack}{\phi_2} \\ \FH{\phi_2}{s}{\phi_3}
}
{\FH{\phi_1}{\StmtStack;s}{\phi_3}}
\;(\textsc{Seq})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{
\forall P \in \ProcName.\ \vdash P \\
\forall 1 \le i \le n.\ G \vdash T_i
}
{
