...
the full set of rules in presented in supplemental material.
...
To achieve this goal, we introduce the {\em Yield Sufficiency Automaton\/} ($\YSA$) that encodes 
...
that the code of each thread in $\Prog$ is simulated by the automaton $\YSA$.
