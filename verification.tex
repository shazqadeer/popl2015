...
\[
D(\lins_y,\lins_a) = 
\disjoint(\{x \mid x \in \lins_y\} \cup \{x \mid x \in \lins_a\})
\]
...
\[
\FH{\Lambda(\phi) \wedge e \wedge D(\Lambda(\lins_y \setminus \Globals),\lins_a)}{s}{\Lambda(\phi)}
\]
...
\[
(\Lambda(\phi) \wedge \rho \wedge D(\Lambda(\lins_y \setminus \Globals),\lins_a)) \circ \alpha \circ \neg\Lambda(\phi)
\]
...
For all $A_1,A_2 \in \ActionName$ such that $\actions(A_1) = (\rho_1,\alpha_1,m_1)$, $\actions(A_2) = (\rho_2,\alpha_2,m_2)$,
$\ProcLins(A_1) = (\lins_1,\lins'_1)$, and$\ProcLins(A_2) = (\lins_2,\lins'_2)$, 
if $m_1 \in \{B,R\}$ or $m_2 \in \{B,L\}$ then prove the following valid:
\[
\begin{array}{l}
(\Lambda_1(\rho_1) \wedge \Lambda_2(\rho_2) \wedge D(\Lambda_1(\lins_1 \setminus \Globals), \Lambda_2(\lins_2))) \\
\circ (\Lambda_1(\alpha_1) \wedge \Same(\FV_2)) \circ (\Lambda_2(\alpha_2) \wedge \Same(\FV_1)) \\ 
\Rightarrow (\Lambda_2(\alpha_2) \wedge \Same(\FV_1)) \circ (\Lambda_1(\alpha_1) \wedge \Same(\FV_2))
\end{array}
\]
...
\[
\Lambda_1(\rho_1) \circ (\Lambda_2(\rho_2) \circ D(\Lambda_1(\lins_1 \setminus \Globals), \Lambda_2(\lins_2)) \circ \Lambda_2(\alpha_2)) \circ \neg \Lambda_1(\rho_1)
\]
For all $A_1,A_2 \in \ActionName$ such that $\actions(A_1) = (\rho_1,\alpha_1,m_1)$ and $\actions(A_2) = (\rho_2,\alpha_2,m_2)$,
if $m_1 \in \{B,L\}$ then prove the following unsatisfiable:
\[
\neg \Lambda_1(\rho_1) \circ (\Lambda_2(\rho_2) \circ D(\Lambda_1(\lins_1 \setminus \Globals), \Lambda_2(\lins_2)) \circ \Lambda_2(\alpha_2)) \circ \Lambda_1(\rho_1)
\]
