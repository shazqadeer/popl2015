...
The judgments $\Refines \jp \Prog$ and $\InterferenceFree(\Prog, \Refines)$ and $\Refines \jr \Prog$, 
...
The judgment $\Refines \jp \Prog$ checks sequential correctness of each computation;
...
The judgment $\vdash \Prog$, formalized in Figure~\ref{fig:linearity}, checks that
...
\item
$\Refines \jp \Prog$ and $\InterferenceFree(\Prog,\Refines)$ and $\Refines \jr \Prog$.
\item
