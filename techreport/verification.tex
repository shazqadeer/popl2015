...
\begin{lemma}
Let $\Prog \in \CProgram$ and $\Prog' \in \Program$ be such that $\vdash \Prog$ and $\vdash \Prog'$.
Let $\Refines \in \ProcName \pf \ActionName$, $\SkipProcs \in 2^{\ProcName}$, $\AvailableActions \in 2^{\ActionName}$,
...
\begin{lemma}
Let $\Prog_1,\Prog_2 \in \CProgram$ and $\Prog'_1 \in \Program$ be such that $\vdash \Prog_1$, $\vdash \Prog'_1$,
