...
{\Refines;\procs;\actions;\RefinementAny;\{\};b \jr \FH{\phi}{\skipstmt}{\phi};b}
\;(\textsc{Skip})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\RefinementAny \in \dom(\Refines) \\ \actions(\Refines(\RefinementAny)) = (\rho, \alpha, m)
}
{\Refines;\procs;\actions;\RefinementAny;\{\};\false \jr \FH{e}{\yield{e,\lins}}{e \wedge \rho};\false}
\;(\textsc{Yield1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\procs;\actions;\RefinementAny;\{\};b \jr \FH{e}{\yield{e,\lins}}{e};b}
\;(\textsc{Yield2})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\RefinementAny \in \dom(\Refines) \Rightarrow \phi \subseteq \rho \\ 
\phi \circ \alpha \circ \neg \psi = \{\} \\
}
{\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi}{\call{A}}{\psi};b}
\;(\textsc{Atomic})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\procs(P) = (\phi, \mods, \psi, \stmt) \\ \RefinementAny \not \in \dom(\Refines)
}
{\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi}{\call{P}}{\psi};b}
\;(\textsc{Call1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\procs(P) = (\phi, \mods, \psi, \stmt) \\ \RefinementAny \in \dom(\Refines) \\\\ 
P \in \dom(\Refines) \\ \actions(\Refines(P)) = (\true,\Havoc(\Local),m) 
}
{\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi}{\call{P}}{\psi};b}
\;(\textsc{Call2})
$
...
{\Refines;\procs;\actions;\RefinementAny;\{\};b \jr \FH{\rho \wedge \phi}{\async{P}}{\rho};b}
\;(\textsc{Async1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{
\procs(P) = (\phi, \mods, \psi, \stmt) \\
\RefinementAny \in \dom(\Refines) \\
P \in \dom(\Refines) \\
\actions(\Refines(P)) = (\true,\Havoc(\Local),m)
}
{\Refines;\procs;\actions;\RefinementAny;\{\};b \jr \FH{\rho \wedge \phi}{\async{P}}{\rho};b}
\;(\textsc{Async2})
$
...
{
\RefinementAny \not \in \dom(\Refines) \\
\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi_1 \wedge e}{s}{\phi_2};b
}
{\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi_1 \wedge e}{\ablock{e,\lins}{s}}{\phi_2};b}
\;(\textsc{Ablock1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\RefinementAny \in \dom(\Refines) \\ \actions \vdash s \preceq \ga{e}{\Havoc(\Local)} \\\\
\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi_1 \wedge e}{s}{\phi_2};b
}
{\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi_1 \wedge e}{\ablock{e,\lins}{s}}{\phi_2};b}
\;(\textsc{Ablock2})
...
\Refines;\procs;\actions;\RefinementAny;\mods;\false \jr \FH{\phi_1 \wedge e}{s}{\phi_2};\false
}
{\Refines;\procs;\actions;\RefinementAny;\mods;\false \jr \FH{\phi_1 \wedge e}{\ablock{e,\lins}{s}}{\phi_2};\true}
\;(\textsc{Ablock3})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\procs;\actions;\RefinementAny;\mods_1;b_1 \jr \FH{\phi_1}{\StmtStack}{\phi_2};b_2 \\\\ 
\Refines;\procs;\actions;\RefinementAny;\mods_2;b_2 \jr \FH{\phi_2}{s}{\phi_3};b_3
}
{\Refines;\procs;\actions;\RefinementAny;\mods_1 \cup \mods_2;b_1 \jr \FH{\phi_1}{\StmtStack;s}{\phi_3};b_3}
\;(\textsc{Seq})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\procs;\actions;\RefinementAny;\mods_1;b \jr \FH{e \wedge \phi_1}{s_1}{\phi_2};b' \\\\
\Refines;\procs;\actions;\RefinementAny;\mods_2;b \jr \FH{\neg e \wedge \phi_1}{s_2}{\phi_2};b'
}
{\Refines;\procs;\actions;\RefinementAny;\mods_1 \cup \mods_2;b \jr \FH{\phi_1}{\ite{\locExpr}{s_1}{s_2}}{\phi_2};b'}
\;(\textsc{Ite})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{e \wedge \locExpr}{s}{e};b
}
{\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{e}{\while{e,\alpha}{\locExpr}{s}}{e \wedge \neg \locExpr};b}
\;(\textsc{While})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\phi \Rightarrow \phi' \\ \Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi'}{\StmtStack}{\psi'};b' \\ \psi' \Rightarrow \psi
}
{\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi}{\StmtStack}{\psi};b'}
\;(\textsc{Weaken})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi}{\StmtStack}{\psi};b' \\ \accessVars(\rho) \cap \mods = \{\}
}
{\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\rho \wedge \phi}{\StmtStack}{\rho \wedge \psi};b'}
\;(\textsc{Frame})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{
\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{\phi}{(\varsL',\StmtStack)}{\psi};b
}
\;(\textsc{Stack})
$
\medskip
...
\mods \subseteq \ThreadLocal \\\\
\Refines;\procs;\actions;\NoProc;\mods;\false \jr \FH{\phi}{\StmtStack}{\true};\false
}
{
...
for each atomic block $\ablock{e,\lins_a}{\stmt} \in \Ablocks(\Prog,\Refines)$, the following judgment holds:
\[
\actions \vdash \stmt \preceq \ga{\Subst(\phi) \wedge e \wedge \disjoint(\Subst(\lins_y \setminus \Global) \cup \lins_a)}{\Subst(\phi)}
\]
...
\end{array}
\]
\item {\bf Gate preservation.}
If $m_1 \in \{B,L\}$ or $m_2 \in \{B,R\}$, then 
$\Subst_1(\rho_1) \circ 
\disjoint(\Subst_1(\lins_1 \setminus \Global) \cup \Subst_2(\lins_2))\ \circ \Subst_2(\rho_2) \circ (\Subst_2(\alpha_2) \wedge \Same(\FV_1))\ \circ 
\neg \Subst_1(\rho_1)$
is the empty set.
\item {\bf Failure preservation.}
If $m_2 \in \{B,L\}$, then 
...
\inferrule
{
\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{e \wedge \locExpr}{s}{e};b \\ e \wedge \locExpr \Rightarrow f \geq 0 \\ 
\alpha = \{(\sigma,\sigma') \mid \sigma(f) > \sigma'(f)\} \\ \actions \vdash \stmt \preceq \ga{(e \wedge \locExpr)}{\alpha}
}
{\Refines;\procs;\actions;\RefinementAny;\mods;b \jr \FH{e}{\while{e,\alpha,f}{\locExpr}{\stmt}}{e \wedge \neg \locExpr};b}
\;(\textsc{While})
}
\]
