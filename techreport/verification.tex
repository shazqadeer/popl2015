...
The two judgments, $\InterferenceSafe(\Prog)$ and $\Refines;\HiddenProcs;\HiddenVars;\bs{b} \jr \Prog$,
...
For example, a yield after a right mover or a yield before a left mover is unnecessary.
The {\em Yield Sufficiency Automaton\/} ($\YSA$) from Figure~\ref{fig:ysa} encodes 
all sequences of atomic actions and yields to capture all behaviors.
