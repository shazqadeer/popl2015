...
\inferrule
{
\Refines;\SkipProcs;\AvailableActions;b \vdash \stmt_1 \leadsto \stmt'_1 \\
\Refines;\SkipProcs;\AvailableActions \vdash \stmt_2 \leadsto \stmt'_2
}
{
\Refines;\SkipProcs;\AvailableActions;b \vdash \stmt_1;\stmt_2 \leadsto \stmt'_1;\stmt'_2
}
\;(\textsc{Seq})
$
\medskip
...
\inferrule
{
\Refines;\SkipProcs;\AvailableActions;b \vdash \stmt \leadsto \stmt'
}
{
\Refines;\SkipProcs;\AvailableActions;b \vdash (P,\varsL,\stmt) \leadsto (P,\varsL,\stmt')
}
\;(\textsc{StackFrame})
$
\medskip
...
\forall i < j \le n.\ \Refines;\SkipProcs;\AvailableActions;b \vdash F_j \leadsto F'_j
}
{
\Refines;\SkipProcs;\AvailableActions;\true \vdash (\varsTL, F_1 \ldots F_{i+1} \ldots F_n) \leadsto (\varsTL, F'_{i+1} \ldots F'_n)
}
\;(\textsc{Thread1})
$
\medskip
...
{
P' \in \dom(\Refines) \\
\forall 1 \le j \le i.\ \Refines;\SkipProcs;\AvailableActions;b \vdash F_j \leadsto F'_j
}
{
\Refines;\SkipProcs;\AvailableActions;\false \vdash (\varsTL, \Frames \cdot (P', \varsL', \stmt') \cdot (P, \varsL, \stmt) \cdot F_1 \ldots F_i) \leadsto (\varsTL, (P, \varsL, \yield{e,\lins}; \call{\Refines(P')};\stmt) \cdot F'_1 \ldots F'_i)
}
\;(\textsc{Thread2})
$
\medskip
...
{
\Refines;\SkipProcs;\AvailableActions;b_1;\ldots;b_n \vdash (\procs, \actions, \ProcLins, \varsG, T_1 \ldots T_n) \leadsto (\procs', \actions', \ProcLins', \varsG, \overrightarrow{T'})
}
\;(\textsc{Program})
$
\medskip
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\{\};b \jr \FH{\phi}{\skipstmt}{\phi};b}
\;(\textsc{Skip})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P;\{\};b \jr \FH{e}{\yield{e,\lins}}{e};b}
\;(\textsc{Yield1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P;\{\};b \jr \FH{e}{\yield{e,\lins}}{e \wedge (\rho \vee b)};b}
\;(\textsc{Yield2})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockInside;P;\mods;b \jr \FH{\phi}{\call{A}}{\psi};b}
\;(\textsc{Atomic})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P;\mods;b \jr \FH{\phi}{\call{P'}}{\psi};b}
\;(\textsc{Call})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P;\{\};b \jr \FH{\phi}{\async{P'}}{\phi};b}
\;(\textsc{Async})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{
P \not \in \dom(\Refines) \cup \SkipProcs \\\\
\Refines;\SkipProcs;\procs;\actions;\ABlockInside;P;\mods;b \jr \FH{\phi_1 \wedge e}{\stmt}{\phi_2};b
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P;\mods;b \jr \FH{\phi_1 \wedge e}{\ablock{e,\lins}{\stmt}}{\phi_2};b}
\;(\textsc{Ablock1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\Refines;\SkipProcs;\procs;\actions;\ABlockInside;P;\mods;\false \jr \FH{\phi_1 \wedge e}{\stmt}{\phi_2};\false
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P;\mods;\false \jr \FH{\phi_1 \wedge e}{\ablock{e,\lins}{\stmt}}{\phi_2};\true}
\;(\textsc{Ablock3})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods_1;b_1 \jr \FH{\phi_1}{\stmt_1}{\phi_2};b_2 \\\\ 
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods_2;b_2 \jr \FH{\phi_2}{\stmt_2}{\phi_3};b_3
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods_1 \cup \mods_2;b_1 \jr \FH{\phi_1}{\stmt_1;\stmt_2}{\phi_3};b_3}
\;(\textsc{Seq})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods_1;b \jr \FH{\locExpr \wedge \phi_1}{s_1}{\phi_2};b' \\\\
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods_2;b \jr \FH{\neg \locExpr \wedge \phi_1}{s_2}{\phi_2};b'
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods_1 \cup \mods_2;b \jr \FH{\phi_1}{\ite{\locExpr}{s_1}{s_2}}{\phi_2};b'}
\;(\textsc{Ite})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods;b \jr \FH{e \wedge \locExpr}{s}{e};b
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods;b \jr \FH{e}{\while{e,\alpha}{\locExpr}{s}}{e \wedge \neg \locExpr};b}
\;(\textsc{While})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods;b \jr \FH{\phi}{\stmt}{\psi};b' \\ \accessVars(\rho) \cap \mods = \{\}
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P;\mods;b \jr \FH{\rho \wedge \phi}{\stmt}{\rho \wedge \psi};b'}
\;(\textsc{Frame1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\mods;b \jr \FH{\phi}{F}{\psi};b' \\ \accessVars(\rho) \cap \mods = \{\}
}
{\Refines;\SkipProcs;\procs;\actions;\mods;b \jr \FH{\rho \wedge \phi}{F}{\rho \wedge \psi};b'}
\;(\textsc{Frame2})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\mods' \subseteq \mods \\
\mods \subseteq \ThreadLocal \\\\
\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P;\mods';P \not \in \dom(\Refines) \jr \FH{\phi}{\stmt}{\psi};\true
}
{
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P;\mods;b \jr \FH{\phi'}{\stmt}{\psi};b' \\\\
\forall \varsG,\varsTL,\varsL'.\ \MakeStore{\varsG}{\varsTL}{\varsL'} \in \phi \Rightarrow \MakeStore{\varsG}{\varsTL}{\varsL} \in \phi'
}
{
\Refines;\SkipProcs;\procs;\actions;\mods;b \jr \FH{\phi}{(P,\varsL,\stmt)}{\psi};b'
}
\;(\textsc{StackFrame})
$
\medskip
...
\forall 1 \le i \le n.\ \Refines;\SkipProcs;\procs;\actions;\mods_i;b_i \jr \FH{\phi_i}{F_i}{\phi_{i+1}};b_{i+1}
}
{
...
%% }
%% {
%% \ABlockOutside \vdash \yield{e,\lins_y}
%% }
%% \;(\textsc{Yield})
%% $
%% \medskip
...
%% \inferrule
%% {
%% \ABlockInside \vdash \stmt
%% }
%% {
%% \ABlockOutside \vdash \ablock{e,\lins_a}{\stmt}
%% }
%% \;(\textsc{Ablock})
%% $
%% \medskip
...
%% \inferrule
%% {
%% \ABlockAny \vdash \stmt_1 \\
%% \ABlockAny \vdash \stmt_2
%% }
%% {
%% \ABlockAny \vdash \stmt_1;\stmt_2
%% }
%% \;(\textsc{Seq})
%% $
%% \medskip
...
%% }
%% {
%% \ABlockAny \vdash \ite{\locExpr}{\stmt_1}{\stmt_2}
%% }
%% \;(\textsc{Ite})
%% $
%% \medskip
...
%% \inferrule
%% {
%% \ABlockAny \vdash \stmt
%% }
%% {
%% \ABlockAny \vdash \while{e,\alpha}{\locExpr}{\stmt}
%% }
%% \;(\textsc{While})
%% $
%% \medskip
...
%% \inferrule
%% {
%% \forall 1 \le i \le n.\ \vdash F_i
%% }
%% {
%% \vdash (\varsTL, F_1 \ldots F_n)
%% }
%% \;(\textsc{Thread})
%% $
%% \medskip
