...
\inferrule
{
\Refines;\SkipProcs;\AvailableActions \vdash \stmt_1 \leadsto \stmt'_1 \\
\Refines;\SkipProcs;\AvailableActions \vdash \stmt_2 \leadsto \stmt'_2
}
{
\Refines;\SkipProcs;\AvailableActions \vdash \stmt_1;\stmt_2 \leadsto \stmt'_1;\stmt'_2
}
\;(\textsc{Seq})
$
\medskip
...
{
\Refines;\SkipProcs;\AvailableActions \vdash (P,\varsL,\stmt) \leadsto (P,\varsL,\stmt')
}
\;(\textsc{StackFrame})
$
\medskip
...
\forall i < j \le n.\ \Refines;\SkipProcs;\AvailableActions \vdash F_j \leadsto F'_j
}
{
...
{
P' \in \dom(\Refines) \\
\forall 1 \le j \le i.\ \Refines;\SkipProcs;\AvailableActions \vdash F_j \leadsto F'_j
}
{
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b,\phi}{\skipstmt}{b,\phi};\{\}}
\;(\textsc{Skip})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P \jr \FH{b,e}{\yield{e,\lins}}{b,e};\{\}}
\;(\textsc{Yield1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P \jr \FH{b,e}{\yield{e,\lins}}{b, e \wedge (\rho \vee b)};\{\}}
\;(\textsc{Yield2})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockInside;P \jr \FH{b,\phi}{\call{A}}{b,\psi};\mods}
\;(\textsc{Atomic})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P \jr \FH{b,\phi}{\call{P'}}{b,\psi};\mods}
\;(\textsc{Call})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P \jr \FH{b,\phi}{\async{P'}}{b,\phi};\{\}}
\;(\textsc{Async})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{
P \not \in \dom(\Refines) \cup \SkipProcs \\\\
\Refines;\SkipProcs;\procs;\actions;\ABlockInside;P \jr \FH{b, \phi_1 \wedge e}{\stmt}{b,\phi_2};\mods
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P \jr \FH{b, \phi_1 \wedge e}{\ablock{e,\lins}{\stmt}}{b, \phi_2};\mods}
\;(\textsc{Ablock1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ABlockOutside;P \jr \FH{\false, \phi_1 \wedge e}{\ablock{e,\lins}{\stmt}}{\true, \phi_2};\mods}
\;(\textsc{Ablock3})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b_1, \phi_1}{\stmt_1}{b_2, \phi_2};\mods_1 \\\\ 
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b_2, \phi_2}{\stmt_2}{b_3, \phi_3};\mods_2
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b_1, \phi_1}{\stmt_1;\stmt_2}{b_3, \phi_3};\mods_1 \cup \mods_2}
\;(\textsc{Seq})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b, \locExpr \wedge \phi_1}{s_1}{b', \phi_2};\mods_1 \\\\
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b, \neg \locExpr \wedge \phi_1}{s_2}{b', \phi_2};\mods_2
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b, \phi_1}{\ite{\locExpr}{s_1}{s_2}}{b', \phi_2};\mods_1 \cup \mods_2}
\;(\textsc{Ite})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b, e \wedge \locExpr}{s}{b, e};\mods
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b, e}{\while{e,\alpha}{\locExpr}{s}}{b, e \wedge \neg \locExpr};\mods}
\;(\textsc{While})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b,\phi'}{\stmt}{b',\psi'};\mods
}
{\Refines;\SkipProcs;\procs;\actions;\ABlockAny;P \jr \FH{b,\phi}{\stmt}{b',\psi};\mods}
\;(\textsc{Weaken})
$
