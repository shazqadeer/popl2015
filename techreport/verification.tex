...
\inferrule
{
\Refines;\SkipProcs;\AvailableActions \vdash \StmtStack \leadsto \StmtStack'
}
{
\Refines;\SkipProcs;\AvailableActions \vdash (\varsL,\StmtStack) \leadsto (\varsL,\StmtStack')
}
\;(\textsc{Stack})
$
\medskip
...
{
\Refines;\SkipProcs;\AvailableActions \vdash \StmtStack;\stmt \leadsto \StmtStack';\stmt'
}
\;(\textsc{Seq})
$
\medskip
...
{
\Refines;\SkipProcs;\AvailableActions \vdash (\varsTL, (\varsL, \StmtStack)) \leadsto (\varsTL, (\varsL, \StmtStack'))
}
\;(\textsc{Thread})
$
\medskip\\
...
\forall 1 \le i \le n.\ \Refines;\SkipProcs;\AvailableActions \vdash T_i \leadsto T_i' \\
\forall P \not\in \dom(\Refines) \cup \SkipProcs.\ \Refines;\SkipProcs;\AvailableActions \vdash \procs(P) \leadsto \procs'(P)
}
{
\Refines;\SkipProcs;\AvailableActions \vdash (\procs, \actions, \ProcLins, \varsG, T_1 \ldots T_n) \leadsto (\procs', \actions', \ProcLins', \varsG, T_1' \ldots T_n')
}
\;(\textsc{Program})
$
\medskip
...
In this section, we formalize the judgments $\Refines;\SkipProcs \jr \Prog$ and $\InterferenceFree(\Prog)$.
...
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\{\};b \jr \FH{\phi}{\skipstmt}{\phi};b}
\;(\textsc{Skip})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\ProcOrNone \not \in \dom(\Refines) \vee \ProcOrNone \in \SkipProcs
}
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\{\};b \jr \FH{e}{\yield{e,\lins}}{e};b}
\;(\textsc{Yield1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\{\};b \jr \FH{e}{\yield{e,\lins}}{e \wedge (\rho \vee b)};b}
\;(\textsc{Yield2})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\ProcOrNone \in \dom(\Refines) \cup \SkipProcs \Rightarrow \phi \subseteq \rho \\ 
\cod((\phi \wedge \rho) \circ \alpha) \subseteq \psi  \\
}
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{\phi}{\call{A}}{\psi};b}
\;(\textsc{Atomic})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\ProcOrNone \in \dom(\Refines) \cup \SkipProcs \Rightarrow P \in \SkipProcs \\
\procs(P) = (\phi, \mods, \psi, \stmt)
}
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{\phi}{\call{P}}{\psi};b}
\;(\textsc{Call})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\{\};b \jr \FH{\phi}{\async{P}}{\phi};b}
\;(\textsc{Async})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{
\ProcOrNone \not \in \dom(\Refines) \cup \SkipProcs \\\\
\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{\phi_1 \wedge e}{\stmt}{\phi_2};b
}
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{\phi_1 \wedge e}{\ablock{e,\lins}{\stmt}}{\phi_2};b}
\;(\textsc{Ablock1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\ProcOrNone \in \dom(\Refines) \cup \SkipProcs \\ \actions \vdash \stmt \preceq \ga{e}{\Havoc(\Local)} \\\\
\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{\phi_1 \wedge e}{\stmt}{\phi_2};b
}
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{\phi_1 \wedge e}{\ablock{e,\lins}{\stmt}}{\phi_2};b}
\;(\textsc{Ablock2})
...
\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;\false \jr \FH{\phi_1 \wedge e}{\stmt}{\phi_2};\false
}
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;\false \jr \FH{\phi_1 \wedge e}{\ablock{e,\lins}{\stmt}}{\phi_2};\true}
\;(\textsc{Ablock3})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods_1;b_1 \jr \FH{\phi_1}{\StmtStack}{\phi_2};b_2 \\\\ 
\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods_2;b_2 \jr \FH{\phi_2}{s}{\phi_3};b_3
}
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods_1 \cup \mods_2;b_1 \jr \FH{\phi_1}{\StmtStack;s}{\phi_3};b_3}
\;(\textsc{Seq})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods_1;b \jr \FH{\locExpr \wedge \phi_1}{s_1}{\phi_2};b' \\\\
\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods_2;b \jr \FH{\neg \locExpr \wedge \phi_1}{s_2}{\phi_2};b'
}
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods_1 \cup \mods_2;b \jr \FH{\phi_1}{\ite{\locExpr}{s_1}{s_2}}{\phi_2};b'}
\;(\textsc{Ite})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{e}{\while{e,\alpha}{\locExpr}{s}}{e \wedge \neg \locExpr};b}
\;(\textsc{While})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{\phi}{\StmtStack}{\psi};b' \\ \accessVars(\rho) \cap \mods = \{\}
}
{\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{\rho \wedge \phi}{\StmtStack}{\rho \wedge \psi};b'}
\;(\textsc{Frame})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\procs(P) = (\phi, \mods, \psi, \stmt) \\
\mods' \subseteq \mods \\\\
\Refines;\SkipProcs;\procs;\actions;P;\mods';\false \jr \FH{\phi}{\stmt}{\psi};P \in \dom(\Refines)
}
{
...
{
\Refines;\SkipProcs;\procs;\actions;\ProcOrNone;\mods;b \jr \FH{\phi}{(\varsL',\StmtStack)}{\psi};b
}
\;(\textsc{Stack})
$
\medskip
...
\mods \subseteq \ThreadLocal \\\\
\Refines;\SkipProcs;\procs;\actions;\None;\mods;\false \jr \FH{\phi}{\StmtStack}{\StateExpr};\false
}
{
\Refines;\SkipProcs;\procs;\actions;\varsG \jr T
}
\;(\textsc{Thread})
$
\medskip
...
\forall 1 \le i \le n.\ \Refines;\SkipProcs;\procs;\actions;\varsG \jr T_i
}
{
\Refines;\SkipProcs \jr (\procs, \actions, \ProcLins, \varsG, T_1 \ldots T_n)
}
\;(\textsc{Program})
$
\medskip
...
We now discuss the judgment $\InterferenceFree(\Prog)$,
