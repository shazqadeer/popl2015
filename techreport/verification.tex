...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;P;\mods_1;b_1 \jr \FH{\phi_1}{\stmt_1}{\phi_2};b_2 \\\\ 
\Refines;\SkipProcs;\procs;\actions;P;\mods_2;b_2 \jr \FH{\phi_2}{\stmt_2}{\phi_3};b_3
}
{\Refines;\SkipProcs;\procs;\actions;P;\mods_1 \cup \mods_2;b_1 \jr \FH{\phi_1}{\stmt_1;\stmt_2}{\phi_3};b_3}
\;(\textsc{Seq})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
\Refines;\SkipProcs;\procs;\actions;P;\mods;b \jr \FH{\phi'}{\stmt}{\psi'};b'
}
{\Refines;\SkipProcs;\procs;\actions;P;\mods;b \jr \FH{\phi}{\stmt}{\psi};b'}
\;(\textsc{Weaken})
$
...
\inferrule
{
\Refines;\SkipProcs;\procs;\actions;P;\mods;b \jr \FH{\phi}{\stmt}{\psi};b' \\ \accessVars(\rho) \cap \mods = \{\}
}
{\Refines;\SkipProcs;\procs;\actions;P;\mods;b \jr \FH{\rho \wedge \phi}{\stmt}{\rho \wedge \psi};b'}
\;(\textsc{Frame1})
$
\medskip
%%%%%%%%%%%%%%%%%%%%
...
If $\Safe(\Prog')$, then there exists $\Prog'_2 \in \CProgram$ and $\bs{b_2} \in \overrightarrow{\mathit{Boolean}}$ such that 
