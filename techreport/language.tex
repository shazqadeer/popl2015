...
$\FrameCtxt \in \mathit{FrameCtxt}$ &::= & $(P, []_{\Local}, \StmtCtxt)$ \\
$\ThreadCtxt \in \mathit{ThreadCtxt}$ &::= &$([]_{\ThreadLocal}, \FrameCtxt\cdot\Frames)$ \\
...
$[]_{\Local}$ for substituting a procedure-local store
