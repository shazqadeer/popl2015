...
The expression $\locExpr \in \LocalStateExpr$ is a predicate that depends only on local variables.
Formally, the predicate satisfies the following property:
$
\forall \varsL.\ (\exists \varsG. \exists \varsTL.\ \MakeStore{\varsG}{\varsTL}{\varsL} \in \locExpr) \Rightarrow (\forall \varsG. \forall \varsTL.\ \MakeStore{\varsG}{\varsTL}{\varsL} \in \locExpr)
$.
