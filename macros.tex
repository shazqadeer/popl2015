...
\newcommand{\AtomicProcName}{\mathit{AtomicProcName}}
...
\newcommand{\ProcSpec}{\mathit{ProcSpecs}}
\newcommand{\ProcRefSpec}{\mathit{ProcRefSpecs}}
...
\newcommand{\while}[3]{ \mathit{while}\ \{{#2}\}\  {{#1}\ } {{#3}\ } }
\newcommand{\termwhile}[3]{ \mathit{twhile}\ \{{#2}\}\  {{#1}\ } {{#3}\ } }
...
\newcommand{\procSpecs}{\mathit{pr}}
\newcommand{\procRefSpecs}{\mathit{pref}}
