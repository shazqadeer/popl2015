...
To justify that reasoning about cooperative semantics is sufficient, 
...
For example, the $\YSA$ a yield after a right mover or a yield before a left mover is unncessary.
