...
The procedure  \exC{L\_SetColGrayIfWhite} holds a global lock while reading
...
{\bf Yield Elimination} Observe that in the procedure \exC{L\_SetColGrayIfWht}, there are no {\tt
